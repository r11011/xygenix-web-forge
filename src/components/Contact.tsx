              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="mr-4 mt-1">
                    <div className="h-10 w-10 rounded-full bg-oxygenix-100 text-oxygenix-600 flex items-center justify-center">
                      <Mail size={20} />
                    </div>
                  </div>
                  <div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:+91-1234567890" className="text-gray-600 hover:text-oxygenix-600">
                      +91-1234567890
                    </a>
                  </div>
                </div>
